...
<body>
    <div id="app">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-gray-100 bg-dots-darker dark:bg-dots-lighter dark:bg-gray-900 shadow-sm ">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            @if (Route::has('home'))
                                <li class="nav-item ">
                                    <a class="nav-link text-white" href="{{ route('home') }}"><b>{{ __('servers') }}</b></a>
                                </li>
                            @endif
